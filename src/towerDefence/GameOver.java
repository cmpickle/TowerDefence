...
public class GameOver {
	...
	g.fillRect(0, 0, Screen.myWidth, Screen.myHeight); // makes a background using mywidth and
							   // myheight to set it apporopriately
	...
	g.fillRect(292, 300, 100, 30); // creates rectangle at position 300, 300 with width 85
				       // height 30
	...
	if (restart == true)
	{
	    ...
	    Screen newScreen = new Screen(frame1);
